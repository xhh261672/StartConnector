...
public class Snake : MonoBehaviour
{
	...
	IEnumerator UpdateSnake ()
	{
		...
		else
		{
			...
			Initialize();// we have to call Start manually because this object is already Instantiated
				Start();
		}
	}
	// ---------------------------------------------------------------------------------------------------
	...
	public void Initialize()
	{
		...
		if (!gameObject.GetComponent<AudioSource>())
		{
			...
			gameObject.AddComponent<AudioSource>();// initialize some audio properties
